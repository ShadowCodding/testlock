...
<html lang="en">
  <head>
    ...
    <title>Add Announcement - <?php echo @$language["SystemName"];?></title>
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/announcements/new" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        <label>Title <span style="color: red;">*</span></label>
                        <input type="text" class="form-control" style="color:white;" name="title" placeholder="es_extended">
                      </div>

                      <div class="form-group">
                        <label>Data <span style="color: red;">*</span></label>
                        <textarea class="form-control" style="color:white;" name="data" id="data" placeholder="New announcmenet!" rows="15"></textarea>
                      </div>
                      
                      <div class="form-group">
                        <label>Status</label>
                        <select class="form-control" name="public" style="width:100%">
