            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                      <center>
                    <h2 class="card-title"><?php echo @$language["offres"];?></h2>
                    </center>
                    <div class="plans">
       			<div class="container">
       			<!-- pricing-grids -->
       			<div class="pricing-grids">
	       			<div class="col-md-3 text-center">
	       			  <div class="pricing-grid">
		       				...
		       				<small> </small>
		       				<big>from</big>
		       				<label><i>$</i><storng>3</storng><i>99</i><em>/month</em></label>
		       				<p><strong>Protection</strong> Protection limitée à 20</p>
		       				<p><strong>(Licences " 40 ")</strong></p>
		       				<p><strong>Obfuscation + IP Lock</strong></p>
		       				<a href="#" class="btn1 btn2 btn-8 btn-8c">GO BUY !</a>
	       			  </div>
	       			</div>
					   <div class="pricing-grids">
						<div class="col-md-3 text-center">
						  <div class="pricing-grid">
								...
								<small> </small>
								<big>from</big>
								<label><i>$</i><storng>9</storng><i>99</i><em>/month</em></label>
								<p><strong>Protection</strong> Protection limitée à 70</p>
								<p><strong>(Licences " 110 ")</strong></p>
								<p><strong>Obfuscation + IP Lock</strong></p>
								<a href="#" class="btn1 btn2 btn-8 btn-8c">GO BUY !</a>
						  </div>
						</div>
						<div class="pricing-grids">
							<div class="col-md-3 text-center">
							  <div class="pricing-grid">
									...
									<small> </small>
									<big>from</big>
									<label><i>$</i><storng>16</storng><i>99</i><em>/month</em></label>
									<p><strong>Protection</strong> Protection limitée à 300</p>
									<p><strong>(Licences " 500 ")</strong></p>
									<p><strong>Obfuscation + IP Lock</strong></p>
									<a href="#" class="btn1 btn2 btn-8 btn-8c">GO BUY !</a>
							  </div>
							</div>
							<div class="pricing-grids">
								<div class="col-md-3 text-center">
								  <div class="pricing-grid">
										...
										<small> </small>
										<big>from</big>
										<label><i>$</i><storng>25</storng><i>99</i><em>All Life</em></label>
										<p><strong>Protection</strong> Protection limitée à ∞</p>
