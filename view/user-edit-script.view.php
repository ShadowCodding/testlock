...
<html lang="en">
  <head>
    ...
    <title>Edit Script - <?php echo @$language["SystemName"];?></title>
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/user/edit/script/<?= $id?>" method="POST">
                      <?php
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?= $row["script"]?>" style="color:white;" name="name" id="exampleInputUsername1" placeholder="es_extended">
                      </div>
                      <div class="form-group">
                        <label>Discord Webhook  <span style="color: red;">*</span></label>
                        <input type="text" class="form-control" style="color:white;" value="<?= $row["webhook"]?>" name="webhook" id="exampleInputUsername1" placeholder="https://discord.com/api/webhooks/xxx">
                      </div>
                      
                      <div class="form-group">
                        <label>Server Side Code  <span style="color: red;">*</span></label>
                        <textarea class="form-control" style="color:white;" name="serverside" id="exampleFormControlTextarea1" rows="15"><?= $row["serverside"]?></textarea>
                      </div>

                      <div class="form-group">
                        <label><?php echo @$language["userComment"];?></label>
                        <textarea class="form-control" style="color:white;" name="description" id="exampleFormControlTextarea1" rows="3"><?= $row["variables"]?></textarea>
                      </div>
