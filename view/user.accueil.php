...
<html lang="en">
  <head>
    ...
    <title>Accueil - <?php echo @$language["SystemName"];?></title>
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0"><?php echo @$language["notif1"];?></h4>
                        <p class="mb-0 font-weight-normal d-none d-sm-block"><?php echo @$language["notif2"];?></p>
                      </div>
                      <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                        <span>
                          <a href="<?=$discordInvite?>" target="_blank" class="btn btn-outline-light btn-rounded get-started-btn"><?php echo @$language["buttonnotif"];?></a>
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                      <center>
                    <h2 class="card-title"><?php echo @$language["accueil"];?></h2>
                    </center>
